...
const countries = [
    ...
    { code: 'IQ', names: { en: 'Iraq', ar: 'العراق' } },
    { code: 'LB', names: { en: 'Lebanon', ar: 'لبنان' } },
    { code: 'SY', names: { en: 'Syria', ar: 'سوريا' } },
    { code: 'LY', names: { en: 'Libya', ar: 'ليبيا' } },
    { code: 'TN', names: { en: 'Tunisia', ar: 'تونس' } },
    { code: 'DZ', names: { en: 'Algeria', ar: 'الجزائر' } },
    { code: 'MA', names: { en: 'Morocco', ar: 'المغرب' } },
    { code: 'SD', names: { en: 'Sudan', ar: 'السودان' } },
    { code: 'YE', names: { en: 'Yemen', ar: 'اليمن' } },
    { code: 'MR', names: { en: 'Mauritania', ar: 'موريتانيا' } },
    { code: 'SO', names: { en: 'Somalia', ar: 'الصومال' } },
    { code: 'DJ', names: { en: 'Djibouti', ar: 'جيبوتي' } },
    { code: 'KM', names: { en: 'Comoros', ar: 'جزر القمر' } },
    { code: 'TR', names: { en: 'Turkey', ar: 'تركيا' } },
    { code: 'IR', names: { en: 'Iran', ar: 'إيران' } },
    { code: 'PK', names: { en: 'Pakistan', ar: 'باكستان' } },
    { code: 'AF', names: { en: 'Afghanistan', ar: 'أفغانستان' } },
    { code: 'MY', names: { en: 'Malaysia', ar: 'ماليزيا' } },
    { code: 'ID', names: { en: 'Indonesia', ar: 'إندونيسيا' } },
    { code: 'BD', names: { en: 'Bangladesh', ar: 'بنغلاديش' } },
    { code: 'IN', names: { en: 'India', ar: 'الهند' } },
    { code: 'CN', names: { en: 'China', ar: 'الصين' } },
    { code: 'JP', names: { en: 'Japan', ar: 'اليابان' } },
    { code: 'KR', names: { en: 'South Korea', ar: 'كوريا الجنوبية' } },
    { code: 'TH', names: { en: 'Thailand', ar: 'تايلاند' } },
    { code: 'PH', names: { en: 'Philippines', ar: 'الفلبين' } },
    { code: 'VN', names: { en: 'Vietnam', ar: 'فيتنام' } },
    { code: 'SG', names: { en: 'Singapore', ar: 'سنغافورة' } },
    { code: 'US', names: { en: 'United States', ar: 'الولايات المتحدة' } },
    { code: 'CA', names: { en: 'Canada', ar: 'كندا' } },
    { code: 'GB', names: { en: 'United Kingdom', ar: 'المملكة المتحدة' } },
    { code: 'DE', names: { en: 'Germany', ar: 'ألمانيا' } },
    { code: 'FR', names: { en: 'France', ar: 'فرنسا' } },
    { code: 'IT', names: { en: 'Italy', ar: 'إيطاليا' } },
    { code: 'ES', names: { en: 'Spain', ar: 'إسبانيا' } },
    { code: 'PT', names: { en: 'Portugal', ar: 'البرتغال' } },
    { code: 'NL', names: { en: 'Netherlands', ar: 'هولندا' } },
    { code: 'BE', names: { en: 'Belgium', ar: 'بلجيكا' } },
    { code: 'CH', names: { en: 'Switzerland', ar: 'سويسرا' } },
    { code: 'AT', names: { en: 'Austria', ar: 'النمسا' } },
    { code: 'SE', names: { en: 'Sweden', ar: 'السويد' } },
    { code: 'NO', names: { en: 'Norway', ar: 'النرويج' } },
    { code: 'DK', names: { en: 'Denmark', ar: 'الدنمارك' } },
    { code: 'FI', names: { en: 'Finland', ar: 'فنلندا' } },
    { code: 'IE', names: { en: 'Ireland', ar: 'أيرلندا' } },
    { code: 'PL', names: { en: 'Poland', ar: 'بولندا' } },
    { code: 'CZ', names: { en: 'Czech Republic', ar: 'التشيك' } },
    { code: 'RO', names: { en: 'Romania', ar: 'رومانيا' } },
    { code: 'HU', names: { en: 'Hungary', ar: 'المجر' } },
    { code: 'GR', names: { en: 'Greece', ar: 'اليونان' } },
    { code: 'CY', names: { en: 'Cyprus', ar: 'قبرص' } },
    { code: 'RU', names: { en: 'Russia', ar: 'روسيا' } },
    { code: 'UA', names: { en: 'Ukraine', ar: 'أوكرانيا' } },
    { code: 'BR', names: { en: 'Brazil', ar: 'البرازيل' } },
    { code: 'AR', names: { en: 'Argentina', ar: 'الأرجنتين' } },
    { code: 'MX', names: { en: 'Mexico', ar: 'المكسيك' } },
    { code: 'CL', names: { en: 'Chile', ar: 'تشيلي' } },
    { code: 'CO', names: { en: 'Colombia', ar: 'كولومبيا' } },
    { code: 'PE', names: { en: 'Peru', ar: 'بيرو' } },
    { code: 'AU', names: { en: 'Australia', ar: 'أستراليا' } },
    { code: 'NZ', names: { en: 'New Zealand', ar: 'نيوزيلندا' } },
    { code: 'ZA', names: { en: 'South Africa', ar: 'جنوب أفريقيا' } },
    { code: 'NG', names: { en: 'Nigeria', ar: 'نيجيريا' } },
    { code: 'KE', names: { en: 'Kenya', ar: 'كينيا' } },
    { code: 'GH', names: { en: 'Ghana', ar: 'غانا' } },
    { code: 'ET', names: { en: 'Ethiopia', ar: 'إثيوبيا' } },
    { code: 'TZ', names: { en: 'Tanzania', ar: 'تنزانيا' } },
    { code: 'UG', names: { en: 'Uganda', ar: 'أوغندا' } },
