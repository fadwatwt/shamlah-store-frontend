export const translations = {
    ar: {
        ...
        home: {
            ...
            bestSellersSub: 'اكتشف أحدث منتجاتنا، طازجة من حرفيينا',
        ...
        product: {
            ...
            addFailed: 'فشلت الإضافة، حاول مجدداً',
        ...
        profile: {
            ...
            emailChangePassword: 'كلمة المرور الحالية (مطلوبة لتغيير البريد الإلكتروني)',
            emailNotEditable: 'لا يمكن تغيير البريد الإلكتروني — للتواصل معنا لطلب التغيير',
            invalidPhoneForCountry: 'رقم الهاتف غير صالح للدولة المحددة — أدخله بالصيغة الدولية مطابقة للدولة (مثال: +970... لفلسطين)',
        },
        orders: {
            title: 'طلباتي',
        ...
        infoPages: {
            ...
            faq: {
                ...
                items: [
                    ...
                    { q: 'كم تستغرق مدة الشحن؟', a: 'الشحن القياسي يستغرق 3-7 أيام عمل حسب وجهتك. تُحسب رسوم الشحن أثناء إتمام الطلب حسب وجهتك وعملتك. يمكنك تتبع طلبك من صفحة طلباتي.' },
            ...
            shipping: {
                ...
                sections: [
                    ...
                    { heading: 'رسوم الشحن', paragraphs: ['تُحسب رسوم الشحن أثناء إتمام الطلب حسب وجهتك وعملتك — وتظهر بوضوح قبل تأكيد الدفع، ولا رسوم خفية أبداً.'] },
    ...
    en: {
        ...
        home: {
            ...
            bestSellersSub: 'Discover our latest products, fresh from our artisans',
        ...
        profile: {
            ...
            emailChangePassword: 'Current password (required to change email)',
            emailNotEditable: 'Email cannot be changed — contact us to request a change',
            invalidPhoneForCountry: 'Phone number is not valid for the selected country — enter it in international format matching the country (e.g. +970... for Palestine)',
        },
        orders: {
            title: 'My Orders',
        ...
        storyPage: {
            ...
            values: {
                ...
                authenticity: {
                    title: 'Authenticity',
                    desc: 'We draw inspiration from the rich Palestinian heritage and preserve its authenticity in every detail',
                },
                craftsmanship: {
                    title: 'Craftsmanship',
                    desc: 'Each piece is crafted by Palestinian artisans with precision and exceptional care',
                },
                luxury: {
                    title: 'Luxury',
                    desc: 'We blend contemporary elegance with authentic heritage in timeless, luxurious designs',
                },
            },
            craft: {
        ...
        infoPages: {
            ...
            faq: {
                ...
                items: [
                    ...
                    { q: 'How long does shipping take?', a: 'Standard shipping takes 3-7 business days depending on your destination. Shipping fees are calculated at checkout based on your destination and currency. You can track your order from the My Orders page.' },
            ...
            shipping: {
                ...
                sections: [
                    ...
                    { heading: 'Shipping fees', paragraphs: ['Shipping fees are calculated at checkout based on your destination and currency — always shown clearly before you confirm payment, never any hidden fees.'] },
