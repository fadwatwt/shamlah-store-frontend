                        ...
                        <form className="space-y-6 max-w-md mx-auto w-full" onSubmit={handleLogin}>
                            ...
                            <div className="space-y-4">
                                <button
                                    ...
                                    className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-200 rounded-md text-gray-700 font-medium hover:bg-gray-50 smooth-transition shadow-sm disabled:opacity-70"
                                    onClick={async () => {
                                ...
                                >
                                    ...
                                    <span>{isGoogleLoading ? (dir === 'rtl' ? 'جاري التحويل...' : 'Redirecting...') : t.auth.google}</span>
                                </button>
